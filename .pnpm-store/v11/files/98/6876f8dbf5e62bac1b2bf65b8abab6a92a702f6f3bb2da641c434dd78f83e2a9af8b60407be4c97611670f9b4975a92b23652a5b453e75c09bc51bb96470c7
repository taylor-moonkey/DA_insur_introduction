import { CoreImageAttributes, UnpicImageProps, CoreSourceAttributes, UnpicSourceProps } from './base.js';
export { BaseImageSourceOptions, DEFAULT_RESOLUTIONS, ImageSourceOptions, Layout, ObjectFit, UnpicBaseImageProps, UnpicBaseSourceProps, getBreakpoints, getSizes, getSrcSet, getSrcSetEntries, getStyle, inferImageDimensions, normalizeImageType } from './base.js';
